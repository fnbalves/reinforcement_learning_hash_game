    ...
    for tries in range(MAX_TRIES):
        try:
            ...
            if latest_state is not None:
                current_q = fetch_q(growing_q_table, latest_state, latest_action)
                next_max  = fetch_max_q(growing_q_table, current_state)
                reward = game.evaluate_state()
                #print('Current reward', reward)
                #print('Previous reward', latest_reward)
                ...
                update_value(growing_q_table, latest_state, latest_action, new_value)
            else:
